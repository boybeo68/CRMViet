...
public class Home_Deathline_Detail_Fragment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_neededdid_and_deathline_and_consigned_detail_activity);
        ...
        if (bundle != null) {
            ...
            tvKhachhang.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!CUSTOMER_ID.equals("")) {
                        ...
                        Intent intent = new Intent(Home_Deathline_Detail_Fragment.this, CustomerDetail_Activity.class);
            ...
            FButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(Home_Deathline_Detail_Fragment.this, TransactionDetail_Editation_Activity.class);
    ...
    public void getToolbar(){
        ...
        llBell.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Home_Deathline_Detail_Fragment.this, Notification_Activity.class);
