...
public class SettingsListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<CustomerType> mParent;
    private ExpandableListView accordion;
    public int lastExpandedGroupPosition;


    public SettingsListAdapter(Context context, ArrayList<CustomerType> parent,
    ...
    public Object getGroup(int i) {
        return mParent.get(i).getCUSTOMER_TYPE_NAME();
    }
...
//        if(mParent.get(i).getChildren().size()>0) {
//        	sub.setText(mParent.get(i).getChildren().toString());
//        }
//        else {
//        	sub.setText("");
//        }
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        textView.setText(mParent.get(i).getChildren().get(i1).getCUSTOMER_GROUP_NAME());

        // set checked if parent category selection contains child category
                if (mParent.get(i).choseType.contains(mParent.get(i).getChildren().get(i1))) {
