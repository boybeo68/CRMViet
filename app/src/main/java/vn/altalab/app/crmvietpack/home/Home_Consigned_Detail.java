...
public class Home_Consigned_Detail extends AppCompatActivity {

    TextView tvTitle, tvKhachhang, tvSodienthoai, tvOffice, tvNguoigiaoviec,tvNguoithuchien, tvDate, tvDes;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home__consigned__detail);
    ...
    public void Action() {
        ...
        tvNguoithuchien = (TextView) findViewById(R.id.tvNguoithuchien);
        ...
        if (bundle != null) {
            ...
            try {
                ASSIGNER = bundle.getString("ASSIGNER");
            } catch (Exception e){
                e.printStackTrace();
            }
            ...
            if (ASSIGNER != null && !ASSIGNER.equals("null")) {
                tvNguoithuchien.setText(ASSIGNER);
            }
            ...
            tvKhachhang.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!CUSTOMER_ID.equals("")) {
                        ...
                        Intent intent = new Intent(Home_Consigned_Detail.this, CustomerDetail_Activity.class);
            ...
            FButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(Home_Consigned_Detail.this, TransactionDetail_Editation_Activity.class);
    ...
    public void getToolbar(){
        ...
        llBell.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Home_Consigned_Detail.this, Notification_Activity.class);
