...
public class Overview_Paid_4columns_Thismonth_Fragment extends Fragment {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.e("OverviewPaid30Fragment", "responseVolleyView430day: " + response);
                        try {
                            if (getActivity() != null)
    ...
    public void getDataAndSetData(String response){
        ...
        if (overviewPaidJson.getStatus() == true){
            ...
            if (overviewPaidJson.getList().size() == 4) {
                    // lưu cache
    ...
    public void getDateAndsetDate(){
        ...
        tvNgay4.setText(getStringDate(overviewPaidJson.getList().get(3).getPAYMENT_DATE()));
        ...
        payment = Long.parseLong(overviewPaidJson.getList().get(3).getTOTAL_MONEY());
        percent = payment / 10 / tonglamtron;
