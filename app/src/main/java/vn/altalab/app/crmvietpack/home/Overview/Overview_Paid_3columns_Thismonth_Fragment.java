...
public class Overview_Paid_3columns_Thismonth_Fragment extends Fragment {

    View view;
    ProgressBar pg1, pg2, pg3;

    TextView tvTien1, tvTien2, tvTien3, tvTien4;
    TextView tvNgay1, tvNgay2, tvNgay3;
    TextView tvTong;
    TextView tvDonvi;
    LinearLayout llrow1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.home_overview_paid_3columns_90days_fragment, container, false);
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.e("OverviewPaid90Fragment", "responseoverviewpaid90day: " + response);
                        try {
                            if (getActivity() != null)
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e("erroroverviewpaid90day", "error: " + error);
            }
        });
    ...
    public void getDataAndSetData(String response){
        ...
        if (overviewPaidJson.getStatus() == true){
            ...
            if (overviewPaidJson.getList().size() == 3) {
    ...
    public void getDateAndsetDate(){
        ...
        tvNgay2.setText(getStringDate(overviewPaidJson.getList().get(1).getPAYMENT_DATE()));
        tvNgay3.setText(getStringDate(overviewPaidJson.getList().get(2).getPAYMENT_DATE()));
        ...
        payment = Long.parseLong(overviewPaidJson.getList().get(1).getTOTAL_MONEY());
        ...
        payment = Long.parseLong(overviewPaidJson.getList().get(2).getTOTAL_MONEY());
        percent = payment / 10 / tonglamtron;
