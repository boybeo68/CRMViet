...
import vn.altalab.app.crmvietpack.notification.Notification_Customer_Fragment;
...
public class Notification_Adapter_Cus extends BaseAdapter {
    ...
    public Notification_Adapter_Cus(Context context, int layout, ArrayList<Notifications_Setget> listNotification) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long b = listNotification.get(position).getObjectId();
                    bundle.putLong("customer_id",  Long.parseLong(String.valueOf(listNotification.get(position).getObjectId())));
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            if (jsonObject.getString("messages").equals("success")) {
                                ...
                                if (Notification_Customer_Fragment.adapter != null) ;


                                listNotification.get(position).setViewStatus(2);
                                Notification_Customer_Fragment.adapter.notifyDataSetChanged();
