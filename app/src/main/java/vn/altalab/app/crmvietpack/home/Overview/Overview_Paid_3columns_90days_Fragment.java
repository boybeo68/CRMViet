...
public class Overview_Paid_3columns_90days_Fragment extends Fragment {
    ...
    public void Action(){
        sharedPreferences = new Shared_Preferences(getActivity(), "overviewpaid90day");
    ...
    public void getDataVolley(){
        ...
        String url = link.get_Home_Overview_Paid_Link(3);
