...
import vn.altalab.app.crmvietpack.notification.Notification_Approval_Fragment;
...
public class Notification_Adapter_Sig extends BaseAdapter {
    ...
    public Notification_Adapter_Sig(Context context, int layout, ArrayList<Notifications_Setget> listNotification) {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            if (jsonObject.getString("messages").equals("success")) {
                                ...
                                if (Notification_Approval_Fragment.notificationAdapter != null) ;

                                listNotification.get(position).setViewStatus(2);
                                Notification_Approval_Fragment.notificationAdapter.notifyDataSetChanged();
