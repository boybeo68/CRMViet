...
public class Overview_Paid_2columns_Thismonth_Fragment extends Fragment {

    View view;
    ProgressBar pg1, pg2;

    TextView tvTien1, tvTien2, tvTien3, tvTien4;
    TextView tvNgay1, tvNgay2;
    TextView tvTong;
    TextView tvDonvi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.home_overview_paid_2columns_thismonth_fragment, container, false);
        }
    ...
    public void findViewID(){
        ...
        llrow = (LinearLayout) view.findViewById(R.id.llrow1);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.e("OverviewPaid2columns", "responseoverviewpaid2columns: " + response);
                        try {
                            if (getActivity() != null)
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e("OverviewPaid2columns", "error: " + error);
            }
        });
    ...
    public void getDataAndSetData(String response){
        ...
        if (overviewPaidJson.getStatus() == true){
            ...
            if (overviewPaidJson.getList().size() == 2) {
                ...
                llrow.setVisibility(View.INVISIBLE);
            }
